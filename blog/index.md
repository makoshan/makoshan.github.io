...
-   **[`Hello World - My First Blog Post`{=html}](/blog/2024/hello){#2024-01-01
    .icon-not
    data-include-selector-not="#return-to-blog-index-link"}** (01⁠-01)

# View Full Posts

## 2024 {#transclude-2024}

::: collapse
**[`Hello World - My First Blog Post`{=html}](/blog/2024/hello){.id-not
.link-annotated-not .icon-not .include-content
